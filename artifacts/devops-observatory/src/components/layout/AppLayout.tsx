          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <item.icon className={cn("w-5 h-5 mr-3 relative z-10", isActive ? "text-primary" : "text-slate-500 group-hover:text-slate-300")} />
        ...
        <div className="p-4 border-t border-white/5">
          <div className="bg-background/50 rounded-xl p-4 border border-white/5">
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm font-medium text-slate-300">All Systems Nominal</span>
            </div>
          </div>
        </div>
      </aside>
